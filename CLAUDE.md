...
4. **Best Practices** (`best-practices/`) — Anonymized, maturity-graduated content for each process area (PR1–PR14) plus cross-cutting patterns. Derived from the knowledge library. Loaded during P3 as starting content, harvested at P5.
...
- **T3 (Full SMS):** 6–14 processes, 16+ roles, ISO 20000/SOC2. 50–80+ docs, all 8 gates.
